...
export default function Contact() {
	...
	//whenever the form is submitted in this func, func will get passed the submit event, so we can use it to get the form data from all the fields
	async function handleSubmit(e) {
		e.preventDefault();

		// Prepare data
		//e.target is form that has been submited
